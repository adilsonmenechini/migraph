...
Purpose:
- Build the MiGraph graph outputs, including document, knowledge, and suggested graph views.

Usage:
- Prefer `python scripts/migraph graph ...`.
...
<body>
  <div class="layout">
    <aside class="panel left">
      <div class="card">
        <h1 class="title">MiGraph Graph</h1>
        <p class="lead">Offline graph explorer for MiGraph. The default view is the content knowledge graph, where you can search, filter, and inspect page structure plus semantic content relations.</p>
      </div>
      <div class="card">
        <div class="stats">

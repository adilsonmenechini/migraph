...
Purpose:
- Describe and check the runtime capabilities that MiGraph depends on for imports and conversions.
...
def missing_dependency_message(source_path: Path, items: list[dict[str, str]]) -> str:
    ...
    return (
        ...
        "Run `python scripts/migraph bootstrap` again after fixing package index or network access, "

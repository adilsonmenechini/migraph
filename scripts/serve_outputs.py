...
Usage:
- Prefer `python scripts/migraph serve ...`.
...
def main() -> int:
    ...
    if args.host not in loopback_hosts:
        print(
            f"Warning: serving MiGraph outputs on {args.host}:{args.port or DEFAULT_SERVE_PORT} "
    ...
    if not output_dir.is_dir():
        print(
            ...
            f"Run `python scripts/migraph viewer --root {display_root_arg(root)}` "
